...
public class LibraryLoaders {
    ...
    public static LibraryLoader loader() {
        ...
        if (type != null) {
            ...
            if (type.equals("nil")) return new com.vivian.common.encrypt.jni.NilLibraryLoader();
            if (type.equals("jar")) return new com.vivian.common.encrypt.jni.JarLibraryLoader();
        ...
        return vmSpec.startsWith("Java") ? new com.vivian.common.encrypt.jni.JarLibraryLoader() : new SysLibraryLoader();
    }
}
