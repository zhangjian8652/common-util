package com.vivian.common.encrypt.util;
...
public class EncryptUtil {
    ...
    public static String BCrypt(String plainPassword) {
        return com.vivian.common.encrypt.crypto.BCrypt.hashpw(plainPassword, com.vivian.common.encrypt.crypto.BCrypt.gensalt(12));
    }
    ...
    public static boolean matchBCrypt(String plainString, String encodeString) {
        return com.vivian.common.encrypt.crypto.BCrypt.checkpw(plainString, encodeString);
    }


    public static String SCrypt(String plainPassword) {
        return com.vivian.common.encrypt.crypto.SCryptUtil.scrypt(plainPassword, 16, 16, 16);
    }

    public static boolean matchSCrypt(String plainString, String encodeString) {
        return com.vivian.common.encrypt.crypto.SCryptUtil.check(plainString, encodeString);
    }

    public static String BASE64(String plainString){
       char[] chars =  com.vivian.common.encrypt.codec.Base64.encode(plainString.getBytes());
        return new String(chars);
    }

    public static String decodeBASE64(String encodeString){
        char[] chars = encodeString.toCharArray();
        byte[] bytes = com.vivian.common.encrypt.codec.Base64.decode(chars);
    ...
    public static void main(String[] args) throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        System.out.println("BCrypt = [" + EncryptUtil.matchBCrypt(password, BCryptString) + "]");
        System.out.println("=======================================================");
